...
ALTER TABLE "organization_members" ALTER COLUMN "role" SET DATA TYPE "public"."role" USING "role"::text::"public"."role";--> statement-breakpoint
...
CREATE UNIQUE INDEX "project_members_unique_member_idx" ON "project_members" USING btree ("project_id","user_id");--> statement-breakpoint
